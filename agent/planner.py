...
def call_llm(messages):
    ...
    providers = [
        ...
        ("Gemini-1 / gemini-2.5-pro",    lambda: gemini1.chat.completions.create(model="gemini-2.5-pro-preview-06-05", messages=messages, temperature=0.2, max_tokens=4096)),
        ("Gemini-2 / gemini-2.5-pro",    lambda: gemini2.chat.completions.create(model="gemini-2.5-pro-preview-06-05", messages=messages, temperature=0.2, max_tokens=4096)),
        ("Gemini-3 / gemini-2.5-pro",    lambda: gemini3.chat.completions.create(model="gemini-2.5-pro-preview-06-05", messages=messages, temperature=0.2, max_tokens=4096)),
